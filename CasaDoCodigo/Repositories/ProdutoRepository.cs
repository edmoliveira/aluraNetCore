...
namespace CasaDoCodigo.Repositories
{
    public interface IProdutoRepository
    {
        ...
        Task<IList<Produto>> GetProdutos(string filter);
    }
    ...
    public class ProdutoRepository : BaseRepository<Produto>, IProdutoRepository
    {
        ...
        public async Task<IList<Produto>> GetProdutos(string filter)
        {
            var valueFilter = filter.Trim();

            return await dbSet
                .Include(c => c.Categoria)
                .Where(c => c.Nome.Contains(valueFilter) || c.Categoria.Nome.Contains(valueFilter))
                .ToListAsync();
        }
