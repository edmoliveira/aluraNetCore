...
namespace CasaDoCodigo.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public async Task<IActionResult> BuscaDeProdutos(string pesquisa)
        {
            ...
            if (pesquisa != null && pesquisa.Trim() != string.Empty)
            {
                lista = await produtoRepository.GetProdutos(pesquisa);
                ...
                if(lista == null || lista.Count == 0)
                {
                    ...
                    // lista = await produtoRepository.GetProdutos();
            ...
            return View(new BuscaDeProdutosViewModel( lista, mensagem));
        }
